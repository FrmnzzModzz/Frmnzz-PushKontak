...
const isAuthor = '6281346214917'+'@s.whatsapp.net'.includes(m.sender)
...
const ownSc = `6281346214917`
const ownScName = `MangFirman`
...
let menu = `*BOT KHUSUS PUSHKONTAK*

┌⁠──────────
○ *Nama Bot :* FRMNZ STORE 
○ *Version Bot :* 9.9.9.9
○ *Nama Owner :* ${ownName}
○ *Nomor Owner :* ${ownNumb}
...
LANGSUNG CHAT OWNER YA..

𝗢𝗪𝗡𝗘𝗥 : ${ownSc}

*☍ GROUP CHAT*
https://chat.whatsapp.com/FGt2imTsrigCMYH01IEhso`
reply(soScript)
break // (?); bot script
...
await chilo.sendMessage(m.chat, { text: `*Kalo mau push ketik ke gni*\n.pushkon2 120363144535686704@g.us|halo meks save mangfirman` }, { quoted: txrk })
}
break
...
if (!isOwner) return reply(mess.owner)
if (!m.isGroup) return reply(mess.group)
if (!dtext) return reply('*SALAH OM TUTOR NYA GINI*\n\n.pushkontak teksnya')
...
if (!phkid) return reply('*SALAH OM TUTOR NYA GINI*\n\n.pushkon2 ID|teksnya')
if (!phktxt) return reply('*SALAH OM TUTOR NYA GINI*\n\n.pushkon2 ID|teksnya')
